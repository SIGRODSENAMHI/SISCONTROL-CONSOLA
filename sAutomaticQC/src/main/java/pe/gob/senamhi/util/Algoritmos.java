	...
	public String LimitesDuros(String variable, String fecha, String hora, String cod_est, Double dato) {
		...
		if (variable.equals("N_LLUVIA")) {
			...
			if ((sum24H >= Linf2) && (sum24H <= Lsup2)) {
				...
				flag.add(fMaloEsp);
//				flagBean = datosDao.obtCodigoFlag("LimitesDuros", variable, "R2"); 74663704
...
//		}
	...
	public String ConsistenciaTemporalPaso_N_HUMEDAD(String variable, String fecha, String hora, String cod_est,
			Double dato) {
...
//			flag.add("D"+codflag);
			...
			if (dif <= pmt1) { // cambio de < a <= con fecha 16/07/2020
				flag.add(fBueno);
			} else {
				flag.add("D" + codflag);
			}
	...
	public String ConsistenciaTemporalPaso_N_AIRTEMP(String variable, String fecha, String hora, String cod_est,
			Double dato) {
...
//	ALGORITMO PARA EL CALCULO DE LOS TEST DE CONSISTENCIA TEMPORAL DE PERSISTENCIA
	public String ConsistenciaTemporalPersistencia(String variable, String fecha, String hora, String cod_est,
			Double dato) {
		if (variable.equals("N_HUMEDAD")) {
	...
	public String ConsistenciaTemporalPersistencia_N_NIVELAGUA(String variable, String fecha, String hora,
			String cod_est, Double dato) {
...
//		Regla retirada segun requerimiento de SGD - FLAG: "D0410402" / Fecha: 15/04/2020
		/*
		 * datosDao = new DatosDaoImpl(); datosBean =
		 * datosDao.listaDatosCuartiles(variable, cod_est,fechaHora,23); if (datosBean
		 * != null) { q1 = datosBean.getQ1(); q3 = datosBean.getQ3(); ric =
		 * datosBean.getRic(); } else { q1 = null;q3 = null;ric = null; }
		 */
...
//		Regla retirada segun requerimiento de SGD - FLAG: "D0410402" / Fecha: 15/04/2020
		/*
		 * datosDao = new DatosDaoImpl(); if ( (desv == null) || (q1 == null) || (q3 ==
		 * null) || (ric == null) ) { flagBean =
		 * datosDao.obtCodigoFlag("ConsistenciaTemporalPaso", variable, "R2"); codflag =
		 * flagBean.getCodFlag(); flag.add("D"+codflag); } else { flagBean =
		 * datosDao.obtCodigoFlag("ConsistenciaTemporalPaso", variable, "R2"); codflag =
		 * flagBean.getCodFlag(); vlef = (q1)-(1.5*ric); vright = (q3)+(1.5*ric);
		 * 
		 * if ( (dato > vlef) && (dato < vright) ) { flagB = fBueno; } else {
		 * flag.add("D"+codflag); } }
		 */
	...
	public String ConsistenciaTemporalPersistencia_N_HUMEDAD(String variable, String fecha, String hora, String cod_est,
			Double dato) {
...
//				System.out.println("DERECHA: " + vright);
	...
	public String ConsistenciaTemporalPersistencia_N_AIRTEMP(String variable, String fecha, String hora, String cod_est,
			Double dato) {
