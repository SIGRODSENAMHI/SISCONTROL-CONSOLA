...
public class ProcesoVariableThread extends Thread {
	...
	private static final Logger LOGGER = Logger.getLogger(ProcesoVariableThread.class);
...
//	private String mes = Util.obtenerMes();
	...
	public ProcesoVariableThread(List<VariableBean> listaVar, String codEsta, String vfec, String vhor, Integer pIniV, Integer pFinV) {
...
//					LOGGER.info("Registrado correctamente: " + cont);
					LOGGER.info("Cadena: " + flagReg + " Variable: " + nomvar + " Codigo: " + codEsta + " Dato: " + datosBean.getDato1() + " FH: " + vfec + vhor);
					myArray.clear();
				}else {
					LOGGER.info("Error: " + codEsta + datosBean.getDato1());
				}
			}
...
//			validar si existe umbral a nivel de estaci�n
...
//					validar si existe umbral a nivel de nacional
		...
		LOGGER.info("MES DE CONTROL: " + mes + " FECHA HORA: " + vfec1 + " " +vhor1);
